...
const staticAnnouncements = [
  {
    id: "static-0",
    date: "2026-06-24",
    title: "Attention Applicants: Interviews (Technical Round & Communication Skills Assessment) for the Free German Language Training Program will commence on 26-06-2026. -- ప్రకటన: ఉచిత జర్మన్ భాష శిక్షణా కార్యక్రమానికి ఎంపికైన అభ్యర్థుల ఇంటర్వ్యూలు (టెక్నికల్ రౌండ్ మరియు కమ్యూనికేషన్ స్కిల్స్ అసెస్‌మెంట్) 26-06-2026 నుండి ప్రారంభమవుతాయి. పూర్తి వివరాల కోసం ఇక్కడ క్లిక్ చేయండి.",
    file_path: "",
    external_text: "",
    external_link: "",
    main_page: "yes",
