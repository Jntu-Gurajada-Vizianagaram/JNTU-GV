...
const staticAnnouncements = [
  {
    id: "static-0",
    date: "2026-06-24",
    title: "Attention Applicants: Interviews (Technical Round & Communication Skills Assessment) for the Free German Language Training Program will commence on 26-06-2026.",
    file_path: "",
    external_text: "",
    external_link: "",
    main_page: "yes",
  ...
  },
  {
    id: "static-1",
    date: "2026-06-25",
    title: "JNTUGV — Free German Language Training Shortlisted Candidates List -- Any Queries Contact 6302403426",
    file_path: "https://api.jntugv.edu.in/media/GLTP - 2026.xlsx",
    external_text: "Download Shortlisted Candidates List",
    external_link: "https://api.jntugv.edu.in/media/GLTP - 2026.xlsx",
    main_page: "yes",
    scrolling: "yes",
    update_type: "circular",
    update_status: "update",
    submitted_by: "admin",
    admin_approval: "accepted",
    file_link: "https://api.jntugv.edu.in/media/GLTP - 2026.xlsx",
    day: 20,
    month: "Jun",
    year: 2026,
    isStatic: true, // Mark as static for identification
  ...
  //   id: "static-0",
  //   date: "2026-06-08",
  //   title: "JNTU-GV Announcement: Faculty Recruitment 2026 in the State Public Universities of Andhra Pradesh Extension of the application timeline by one week. Click here to view details. -- ప్రకటన: జెఎన్టీయూ-జీవి నియామక ప్రకటన 2026 - ఆంధ్రప్రదేశ్ రాష్ట్ర ప్రభుత్వ విశ్వవిద్యాలయాలలో ఫ్యాకల్టీ నియామక 2026 కోసం దరఖాస్తు సమయం ఒక వారంతో పొడిగించబడింది. పూర్తి వివరాల కోసం ఇక్కడ క్లిక్ చేయండి.",
