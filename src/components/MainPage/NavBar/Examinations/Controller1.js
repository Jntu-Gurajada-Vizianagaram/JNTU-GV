      ...
      <div className="allRightContent">
        ...
        <div className="allRightContent-Profile">
          ...
          <div className="profileName">
            ...
            <h3 className="ADh3">Dr. Chinta Neelima Devi</h3>
            <h3 className="ADh3">Additional Controller of Examinations</h3>
            <h4 className="ADh4">for IV B.Tech and IV B.Pharmacy <br /> Associate Professor in the Department of Mechanical Engineering</h4>
          </div>
