    ...
    <div className="dir-profile-container">
      ...
      <div className="dir-profile-header">
        ...
        <div className="dir-profile-info">
          ...
          <div className="dir-profile-website">
            <a href="https://iqac.jntugv.edu.in/" className="dir-action-link" target="_blank" rel="noopener noreferrer">Visit IQAC Website</a>
          </div>
        </div>
      </div>
      ...
      {activeTab === "about" && (
        <div className="dir-profile-details">
          <p className="dir-sub-heading">Directorate of Internal Quality Assurance Cell (IQAC)</p>
          <p>
            The Internal Quality Assurance Cell (IQAC) at JNTU-GV is responsible for maintaining and enhancing the quality of academic and administrative performance. Its core duties include:
          </p>
          <p>❖ Continuous monitoring and improvement of institutional quality metrics for NAAC, NBA, and other national/international accreditations.</p>
          <p>❖ Implementing comprehensive feedback systems from all stakeholders including students, faculty, alumni, and industry partners.</p>
          <p>❖ Promoting a vibrant culture of quality through regular workshops, seminars, and quality-related benchmarks.</p>
          <p>❖ Preparation of the Annual Quality Assurance Report (AQAR) as per NAAC guidelines.</p>
          <p>❖ Development and application of quality benchmarks for various academic and administrative activities of the university.</p>
        </div>
      )}
