  ...
  return (
    <div className="mainContainer">
      <div className="allRightContent">
        ...
        <p>❖ Working as Professor of Mathematics at JNTUGV, Vizianagaram since June 2025.</p>
        ...
        <p>❖ Officer on Special duty (OSD)(i/c) to the Hon’ble Vice-Chancellor, JNTUGV, Vizianagaram since July 2025.</p>
        <p>❖ Director (i/c), IQAC, JNTUGV, Vizianagaram since July 2025.</p>
        <p>❖ Head, Department of BS&HSS, JNTUK University College of Engineering, Vizianagaram for 6 years.</p>
        <p>❖ Officer In-Charge, Library, JNTUK University College of Engineering, Vizianagaram for 1 year.</p>
        <p>❖ Convener, FFC visits to Engineering, MCA, Management and Pharmacy Colleges affiliated to JNTUK, JNTUGV since 2013.</p>
        <p>❖ Member, College Academic Committee and Departmental Committee, JNTUK University College of Engineering, Vizianagaram for 10 years.</p>
        ...
        <p>❖ Chairman, Board of Studies, BS&HSS, JNTUK University College of Engineering, Vizianagaram for 3 years.</p>
        <p>❖ Member, Research Review Committee, Department of BS&HSS(Mathematics) JNTUGV, Vizianagaram since November 2024.</p>
        ...
        <p>❖ Awarded 5 Ph.Ds., 2 M.Phils., 12 Scholars are working for Ph. D at present.</p>
        ...
        <p>❖ Served as Vice-President for Andhra Pradesh Society for Mathematical Sciences (Regd. No. 1310/1986) for 2 years.</p>

        <p className="ADsub">Societal Contributions :</p>
        <p>❖ Worked as Treasurer/ Secretary for Moulana Abul Kamal Azaad Trust (Regd. No: 78/2003) for 20 years.</p>
        ...
        <p>❖ Stood College Topper at Degree and PG level.</p>
      </div>
    </div>
  );
}
