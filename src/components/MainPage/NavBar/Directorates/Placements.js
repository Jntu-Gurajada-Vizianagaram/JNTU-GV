    ...
    <div className="dir-profile-container">
      ...
      <div className="dir-profile-header">
        ...
        <div className="dir-profile-info">
          ...
          <p className="dir-profile-website">
            Website: <a href="https://dirp.jntugv.edu.in/" target="_blank" rel="noreferrer">https://dirp.jntugv.edu.in/</a>
          </p>
        </div>
      </div>
      ...
      <div className="dir-profile-details">
        ...
        <p>
          ...
          <a href="https://www.scopus.com/authid/detail.uri?authorId=6506204413" target="_blank" rel="noreferrer">(https://www.scopus.com/authid/detail.uri?authorId=6506204413)</a>
        </p>
        <p>
          ❖ Google h-index : 16 <br />
          <a href="https://scholar.google.co.in/citations?user=S7TNMfsAAAAJ&hl=en" target="_blank" rel="noreferrer">(https://scholar.google.co.in/citations?user=S7TNMfsAAAAJ&hl=en)</a>
        </p>
